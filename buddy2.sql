...
-- 1:1 문의 더미 데이터 삽입
INSERT INTO community(title, content, author, lev) VALUES('질문1', '질문1 내용입니다.', 'kim', 0);
INSERT INTO community(title, content, author, lev) VALUES('질문2', '질문2 내용입니다.', 'lee', 0);
INSERT INTO community(title, content, author, lev) VALUES('질문3', '질문3 내용입니다.', 'park', 0);
INSERT INTO community(title, content, author, lev) VALUES('질문4', '질문4 내용입니다.', 'so', 0);
INSERT INTO community(title, content, author, lev) VALUES('질문5', '질문5 내용입니다.', 'yoon', 0);
UPDATE community SET par=comuno WHERE lev = 0;

INSERT INTO community(title, content, author, lev, par) VALUES('질문1 답변', '답변 내용', 'park', 1, 1);
INSERT INTO community(title, content, author, lev, par) VALUES('질문2 답변', '답변 내용', 'so', 1, 2);
INSERT INTO community(title, content, author, lev, par) VALUES('질문3 답변', '답변 내용', 'admin', 1, 3);
INSERT INTO community(title, content, author, lev, par) VALUES('질문4 답변', '답변 내용', 'admin', 1, 4);
INSERT INTO community(title, content, author, lev, par) VALUES('질문5 답변', '답변 내용', 'admin', 1, 5);
...
CREATE TABLE commucomment(
   ...
   resdate TIMESTAMP DEFAULT CURRENT_TIMESTAMP(),
   content VARCHAR(200),
   FOREIGN KEY(comuno) REFERENCES community(comuno) ON DELETE CASCADE
);

-- 댓글 더미 데이터 삽입
INSERT INTO commucomment(comuno, author, content) VALUES(9, 'kim', '테스트용 댓글');
INSERT INTO commucomment(comuno, author, content) VALUES(4, 'lee', '테스트용 댓글');
INSERT INTO commucomment(comuno, author, content) VALUES(5, 'park', '테스트용 댓글');
INSERT INTO commucomment(comuno, author, content) VALUES(7, 'so', '테스트용 댓글');
INSERT INTO commucomment(comuno, author, content) VALUES(8, 'yoon', '테스트용 댓글');

COMMIT;

CREATE TABLE community(comuno INT PRIMARY KEY AUTO_INCREMENT,
title VARCHAR(200) NOT NULL,
content VARCHAR(1000),
author VARCHAR(16),
resdate TIMESTAMP DEFAULT CURRENT_TIMESTAMP(),
...
-- qnalist 뷰 생성
CREATE VIEW cmList AS (SELECT a.comuno AS comuno, a.title AS title, a.content AS content, 
a.author AS author, a.resdate AS resdate, a.cnt AS cnt, a.lev AS lev, a.par AS par, b.name AS NAME
FROM community a, member b WHERE a.author=b.id ORDER BY a.par DESC, a.lev ASC, a.comuno ASC);
