    ...
    <div class="wrap">
        ...
        <div class="contents" id="contents">
            <div class="breadcrumb">
                <p><a href="/">HOME</a> &gt; <a href="/community/qnaList.jspst.jsp">질문 및 답변</a> &gt; <span>질문 및 답변 글 상세보기</span></p>
            </div>
                    ...
                    <table class="tb1" id="myTable">
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <% if(qna.getLev()==0) { %>
                                <% if(sid!=null) { %>
                                <a href="/community/addQuestion.jspon.jsp?lev=1&par=<%=qna.getQno() %>" class="inbtn">답변하기</a>
                                <% } %>
                                <% if(sid!=null && (sid.equals("admin") || sid.equals(qna.getAuthor()))) { %>
                                <a href="/community/updateQna.jspna.jsp?qno=<%=qna.getQno() %>" class="inbtn">질문 수정하기</a>
                                <a href="/community/delQna.jspna.jsp?qno=<%=qna.getQno() %>&lev=0" class="inbtn">질문 삭제하기</a>
                                <% } %>
                                <% } else { %>
                                <% if(sid!=null && (sid.equals("admin") || sid.equals(qna.getAuthor()))) { %>
                                <a href="/community/updateQna.jspna.jsp?qno=<%=qna.getQno() %>" class="inbtn">답변 수정하기</a>
                                <a href="/community/delQna.jspna.jsp?qno=<%=qna.getQno() %>&lev=1" class="inbtn">답변 삭제하기</a>
                                <% } %>
                                <% } %>
